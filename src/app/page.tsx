...
export default function Home() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-50 to-indigo-100 py-40 px-6">
        <GridLayout>
      ...
      {/* Use Cases Section */}
      <section className="py-40 bg-gray-50 px-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Powerful Use Cases
      ...
      {/* Stats Section */}
      <section className="py-40 bg-blue-600 text-white px-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
          <div className="text-center mb-20">
      ...
      {/* CTA Section */}
      <section className="py-40 bg-gray-900 text-white px-6">
