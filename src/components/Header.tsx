      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="text-2xl font-bold text-white" style={{ fontFamily: 'var(--font-pacifico)' }}>
              Callisto
            </Link>
          </div>
              ...
              {/* Software Dropdown */}
              <NavigationMenuItem>
                <NavigationMenuTrigger className="text-gray-300 hover:text-white bg-transparent px-6 py-3 rounded-md hover:bg-gray-800 transition-colors">
                  Software
                </NavigationMenuTrigger>
                <NavigationMenuContent>
              ...
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link href="/about" className={cn(navigationMenuTriggerStyle(), "text-gray-300 hover:text-white bg-transparent px-6 py-3 rounded-md hover:bg-gray-800 transition-colors")}>
                    About
                  </Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
              ...
              <NavigationMenuItem>
                <NavigationMenuLink asChild>
                  <Link href="/contact" className={cn(navigationMenuTriggerStyle(), "text-gray-300 hover:text-white bg-transparent px-6 py-3 rounded-md hover:bg-gray-800 transition-colors")}>
                    Contact
                  </Link>
                </NavigationMenuLink>
              </NavigationMenuItem>
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            >
              Login
                    ...
                    <Link
                      href="/book-demo"
                      className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-4 py-2 rounded-md text-sm font-medium shadow-lg transition-colors"
                    >
                      Book Demo
                    </Link>
          </div>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t">
              ...
              <div className="pt-4 space-y-2">
                ...
                <Link
                  href="/book-demo"
                  className="block px-3 py-2 text-base font-medium bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-md hover:from-blue-700 hover:to-cyan-700"
                >
                  Book Demo
                </Link>
              </div>
