                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Introducing AI-Powered File Management</span>
                                    ...
                                    <p
                                        ...
                                        Highly customizable file organization system for building modern document workflows and applications that scale with your business needs.
                                    </p>
                                </AnimatedGroup>
...
const menuItems = [
    { name: 'Software', href: '/software/file-management' },
    { name: 'Industries', href: '/industries/healthcare' },
    { name: 'Use Cases', href: '/use-cases/automation' },
