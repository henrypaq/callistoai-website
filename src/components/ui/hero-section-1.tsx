                ...
                <section>
                    <div className="relative pt-24 md:pt-36">
                        <AnimatedGroup
                            ...
                            <img
                                src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=3276&h=4095&fit=crop&crop=center"
                                alt="background"
                        ...
                        <div
                            ...
                            style={{
                                background: `radial-gradient(circle at center top, rgba(0, 255, 255, 0.08) 0%, rgba(0, 128, 255, 0.08) 30%, rgba(0, 128, 0, 0.08) 60%, rgba(0, 0, 0, 0) 80%)`,
                            }}
                        />
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Introducing Advanced File Management</span>
                        ...
                        <AnimatedGroup
                            ...
                            <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                ...
                                />
                                <div className="inset-shadow-2xs ring-black dark:inset-shadow-white/20 bg-black relative mx-auto max-w-6xl overflow-hidden rounded-2xl border border-gray-700 p-4 shadow-lg shadow-zinc-950/15 ring-1">
                                    <img
