...
export const TestimonialStack = ({ testimonials, visibleBehind = 2 }: TestimonialStackProps) => {
  ...
  return (
    <section className="testimonials-stack relative flex justify-center">
      <div className="relative w-full max-w-3xl h-[380px] px-4 mx-auto">
      {testimonials.map((testimonial, index) => {
        ...
        return (
          <div
            ...
            key={testimonial.id}
            className="testimonial-card glass-effect backdrop-blur-xl absolute left-1/2 -translate-x-1/2 w-full"
              ...
              <div className="flex items-start justify-between mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-200/80 mt-1">{testimonial.role}</p>
                  </div>
                </div>
              </div>
              
              <blockquote className="text-white/90 leading-relaxed text-lg md:text-xl mb-6">"{testimonial.quote}"</blockquote>
              
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between border-t border-white/15 pt-4 gap-4">
                  ...
                  {testimonial.stats.map((stat, i) => {
                    ...
                    return (
                      <span key={i} className="flex items-center">
                        <IconComponent className="mr-1.5 h-3.5 w-3.5 opacity-80" />
                        {stat.text}
                      </span>
                    );
                  })}
      ...
      <div className="pagination flex gap-2 justify-center mt-4 mb-2">
